(define (problem pb6)
  ...
  (:goal (and
         (on c01)  (not (on c02))      (on c03)  (not (on c04))
    (not (on c05)) (not (on c06)) (not (on c07))      (on c08)
    (not (on c09))      (on c10)  (not (on c11)) (not (on c12))
    (not (on c13))      (on c14)       (on c15)       (on c16)
  ))
)